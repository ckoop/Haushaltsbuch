...
Ebenfalls offen: Datenexport, Mehrwährungsfähigkeit (auch im Depot keine Umrechnung Fremdwährung → Euro), FIFO/LIFO-Berechnung im Depot (nur Durchschnittsmethode), gespeicherte/historische Depot-Kurse (immer nur der zuletzt live abgerufene, nie in der DB).
